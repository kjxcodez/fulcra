    ...
    <section className="border-t border-border py-20 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-8">
          {/* Left Column (Panel on desktop with 3D Tilt) */}
              ...
              <div className="rounded-xl border border-border bg-card p-6 shadow-sm transition-shadow duration-300 hover:shadow-lg sm:p-8">
                ...
                <div className="space-y-2 font-mono text-xs leading-relaxed">
                  ...
                  <div className="text-success-text rounded border border-success/30 bg-success/15 px-3 py-2 font-medium">
                    + Built and scaled distributed backend services handling
                    40M+ daily requests
                  </div>
                </div>
                ...
                <div className="mt-5 border-t border-border/80 pt-4 text-xs leading-relaxed text-muted-foreground">
                  ...
                  Work history → RapidQuest Solutions, &quot;Platform
                  scale&quot; evidence entry (verified 2024–2026).
                </div>
              </div>
            </Tilt3D>
          </div>
