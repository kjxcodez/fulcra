...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-[rgba(20,22,31,0.48)] duration-[var(--motion-complex)] supports-backdrop-filter:backdrop-blur-xs data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        className
      )}
      {...props}
    />
    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Popup
        ...
        className={cn(
          ...
          "shadow-[0_12px_32px_rgba(20,22,31,0.16)]",
          "duration-[var(--motion-complex)] outline-none",
