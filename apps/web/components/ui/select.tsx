...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-fit items-center justify-between gap-1.5 rounded border border-input bg-transparent py-2 pr-2 pl-3 text-sm whitespace-nowrap transition-colors outline-none select-none",
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            ...
            "shadow-[0_2px_8px_rgba(20,22,31,0.08)]",
