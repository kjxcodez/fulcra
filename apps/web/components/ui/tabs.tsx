  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "gap-1.5 rounded border border-transparent px-2 py-0.5",
        "text-sm font-medium whitespace-nowrap",
        "text-muted-foreground transition-all",
        "group-data-vertical/tabs:w-full group-data-vertical/tabs:justify-start",
        "hover:text-foreground",
        "focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/45 focus-visible:ring-offset-0 focus-visible:outline-none",
        "disabled:pointer-events-none disabled:opacity-50",
        "has-data-[icon=inline-end]:pr-1 has-data-[icon=inline-start]:pl-1",
        "aria-disabled:pointer-events-none aria-disabled:opacity-50",
        // Default (segmented) variant active
        ...
        // Line variant active — Indigo text, no background
        ...
        // Active underline indicator — uses primary (Indigo)
